...
corner_spot_cord = [1550, 10]
sell_rune_cord = [660, 740]
...
# TOA Cord
start_battle_button_cord = [1350, 630]
# BattleRiftDungeonResult
open_rune_cord = [1000, 500]
...
open_chest = [1500, 55]
get_grind = [920, 630]
get_enchant_gem = [920, 630]
get_mana = [795, 640]
sell_grind = [700, 633]
confirm_sell_grind = [650, 600]
restart_run = [650, 537]
